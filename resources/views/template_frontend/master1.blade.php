    ...
    <section class="portfolio bg-primary" id="portfolio">
        <div class="container">
            <div class="rows ">
                ...
                <div class="row mt-2 mb-2 justify-content-center" >
                     <a href="{{route('stunting_index')}}" class="mr-2 mb-2"><img src="{{asset('image/7lokus.png')}}" alt="" data-aos="zoom-in-down"></a>
                     <a href="{{route('kawasan_index')}}" class="mr-2 mb-2"><img src="{{asset('image/8kawasan.png')}}" alt="" data-aos="zoom-in-down"></a>
                     <a href="{{route('idm_index')}}" class="mr-2 mb-2"><img src="{{asset('image/9nilaistatusidm.png')}}" alt="" data-aos="zoom-in-down"></a>
