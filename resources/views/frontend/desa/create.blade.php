        ...
        <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <h2 class="text-center"><b>TAMBAH DESA</b></h2>
                  ...
                  <div class="form-group col-md-4">
                      <label for="">ID</label>
                      <input type="text" class="form-control" name="id" placeholder="Id" required value="{{$errors->any() ? old('id') : ''}}">
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" name="kode_desa" placeholder="Kode Desa" required value="{{$errors->any() ? old('kode_desa') : ''}}">
                  </div>
                  <div class="form-group col-md-4">
                      <label for="">Kecamatan</label>
                      <input type="text" class="form-control" name="kecamatan" placeholder="Kode Desa" required value="{{$errors->any() ? old('kecamatan') : ''}}">
                  </div>
                  </div>
                  {{-- row2 --}}
                  <div class="row">  
                      <div class="form-group col-md-4">
                          ...
                          <input type="text" class="form-control" name="status_desa"  placeholder="Status Desa" required value="{{$errors->any() ? old('status_desa') : ''}}">
                      </div>
                      <div class="form-group col-md-4">
                          <label for="">Prioritas Desa</label>
                          <input type="text" class="form-control" name="prioritas_desa" placeholder="Prioritas Desa" required value="{{$errors->any() ? old('prioritas_desa') : ''}}">
                      </div>
                      <div class="form-group col-md-4">
                          <label for="">Luas Desa</label>
                          <input type="text" class="form-control" name="luas_desa" placeholder="Luas Desa" required value="{{$errors->any() ? old('luas_desa') : ''}}">
                      </div>             
                  </div>
                  <div class="row">  
                      <div class="form-group col-md-6">
                          <label for="">Persentase Luas Desa terhadap Kecamatan</label>
                          <input type="text" class="form-control" name="luas_persen" placeholder="Luas Persen" required value="{{$errors->any() ? old('luas_persen') : ''}}">
                      </div>             
                  <div class="form-group col-md-6">
                      <label for="">Kepadatan Penduduk</label>
                      <input type="text" class="form-control" name="kepadatan_penduduk"  placeholder="Kepadatan Penduduk" required value="{{$errors->any() ? old('kepadatan_penduduk') : ''}}">
                  </div>
                  </div>
