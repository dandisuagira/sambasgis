            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <h2 class="text-center"><b>DETAIL DUSUN</b></h2>
                  ...
                  @auth
                  <a href="{{url('dusun/'.$model->id.'/edit')}}"><button type="button" class="btn btn-info float-left mr-2 mb-2"><i class="fas fa-pencil-alt"></i> Edit</button></a>
                @else
                  {{-- <a type="button" href="{{ route('login') }}"
                      class="btn btn-primary float-right mb-2">Login</a> --}}
                @endauth
                <a href="{{ route('dusun_index') }}"><button type="button" class="btn btn-danger float-left mr-2"><i class="fas fa-times"></i> Kembali</button></a>
