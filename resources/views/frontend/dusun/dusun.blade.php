            ...
            <div class="row">
                <div class="col col1" data-aos="fade-right">
                    <div class="container-fluid">
                        ...
                        @auth
                        <a type="button" href="{{ route('dusun.index') }}" class="btn btn-primary float-left mt-2 mb-2">Desa Index</a>
                        @else
                        @endauth
                    </div>
                </div>
...
@push('javascript')
    ...
    <script>
        ...
        var sambasDusun = new L.layerGroup();
        ...
        $.getJSON(wfs_url_adm).then((res) =>{
            ...
            //warna berdasarkan banyak dusun
            ...
            var layer = L.geoJson(res, {
                onEachFeature: function(f,l) {
                    ...
                    var isPopup =
                            ...
                            "</li><li class='list-group-item'>Nama Dusun : " + NamaDusun +
                            "</li><li class='list-group-item'>Jumlah Dusun : " + JumlahDusun +
                            "</li><li class='list-group-item'>Jumlah RT : " + JumlahRt +
                            "</li><li class='list-group-item'>Jumlah RW : " + JumlahRw +
                            "</li><li class='list-group-item'><a href='dusun/" +
                ...
                style : function(feature){
                    ...
                    for (let i = 0; i < dusun.length; i++) {
                    // console.log(sites[i].kode_desa);
                    if (dusun[i].desa_id == feature.properties.kode_desa) {
                        JumlahDusun = dusun[i].jumlah_dusun;
                        }
                    }
                    console.log(JumlahDusun)
                   ...
                   return { 
                    opacity: 0.9,
                    color: getColorDB(JumlahDusun),
                    fillColor: getColorDB(JumlahDusun)
                    // color: getColor(feature.properties.status_idm),
                    // fillColor: getColor(feature.properties.status_idm)
                }
                    }
        ...
        //     var datas = L.featureGroup(array).addTo(map);
            ...
            var legend1 = L.control({ position: "bottomright" });
                ...
                div.innerHTML += '<i style="background: green"></i><span>Dusun</span><br>';
                div.innerHTML += "<hr>";
                div.innerHTML += "<h4>Jumlah Dusun</h4>";
                div.innerHTML += '<i style="background: grey"></i><span><= 2</span><br>';
                div.innerHTML += '<i style="background: cyan"></i><span><= 3</span><br>';
                div.innerHTML += '<i style="background: green"></i><span><= 4</span><br>';
                div.innerHTML += '<i style="background: yellow"></i><span><= 5</span><br>';
