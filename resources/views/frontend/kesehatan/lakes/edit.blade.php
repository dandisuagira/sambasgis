...
<section class="about" id="about">
    <h2 class="text-center"><b>EDIT LAYANAN KESEHATAN</b></h2>
    <form action="{{ url('lakes/' . $lakes->id) }}}"  method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-8">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="row text-center">
                    ...
                    @else
                    @endauth
                    <a href="{{ url('lakes/' . $lakes->id) }}}"><button type="button" class="btn btn-danger ml-3 mr-2"><i
