...
<section class="about" id="about">
     <h2 class="text-center"><b>DETAIL PUSKESMAS</b></h2>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{asset('image/puskesmastemajuk.jpg')}}" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{asset('image/puskesmaspaloh.jpeg')}}" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{asset('image/rs1.jpg')}}" alt="Third slide">
                        </div>
                    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="row text-center">
                    @auth
                    <a href="{{route('editPuskesmas',$puskesmas->id)}}"><button type="button" class="btn btn-info ml-3  mr-2 mb-2"><i
